...
public class CoordTrans {
	...
	public static double[] geo2Coord(double longitude, double latitude) {
	...
	public static double[][] geo2Coord(double longitude[], double latitude[]) {
		...
		for(int i=0;i<longitude.length;i++) {
			double[] coordI = geo2Coord(longitude[i],latitude[i]);
			coord[0][i]=coordI[0];
			coord[1][i]=coordI[1];
		}
		return coord;
	...
	public static double[] geo2Coord(Point point) {
		...
		return geo2Coord(longitude,latitude);
	}
	
	public static double[] coord2Geo(double x, double y) {
	...
	public static double[][] coord2Geo(double x[], double y[]) {
		...
		for(int i=0;i<x.length;i++) {
			double[] geographyI = coord2Geo(x[i],y[i]);
